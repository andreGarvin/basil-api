...
export const ORG_DOMAIN = process.env.ORG_DOMAIN || "basil.com";
// this is is for handling emails sent by the service service
export const NO_REPLY =
  process.env.NO_REPLY || `basil <no-reply@${ORG_DOMAIN}.com>`;
...
export const MAX_USERNAME_LENGTH: number =
  parseInt(process.env.MAX_CHARACTER_SIZE, 10) || 20;
...
// weather or not to upload files to aws s3
export const NO_UPLOAD = Boolean(process.env.NO_UPLOAD) === false;
